            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item ">
                            <a href="/major" class='sidebar-link'>
                                <i class="fa-solid fa-chart-simple"></i>
                                <span>Manajemen Jurusan</span>
                            </a>
                        </li>
                        <li class="sidebar-item ">
                            <a href="/kompetensistandar" class='sidebar-link'>
                                <i class="fa-solid fa-chart-simple"></i>
                        ...
                        {{-- <li class="sidebar-item ">
                            <a href="/admin/assessor" class='sidebar-link'>
                                <i class="fa-solid fa-chart-simple"></i>
                                <span>Assessor</span>
                            </a>
                        </li> --}}
        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <div class="d-flex justify-content-end p-4" style="margin-top: -50px;">
                    <div class="dropdown">
                      <a href="profil" class="d-flex align-items-center text-decoration-none" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="dropdownMenuButton">
                        ...
                        <li><a class="dropdown-item" href="/profil"><i class="bi bi-person me-2"></i> View Profile</a></li>
